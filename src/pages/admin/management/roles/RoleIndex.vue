...
import DialogDelete from "pages/admin/management/roles/Dialog/DialogDelete.vue";
import DialogEdit from "pages/admin/management/roles/Dialog/DialogEdit.vue";
import DialogCreate from "pages/admin/management/roles/Dialog/DialogCreate.vue";
  ...
  <q-page padding>
    ...
    <q-card>
      <q-table
        ...
        :rows="table.data ?? []"
        :selection="can('admin.management.roles.deleteRole') ? 'multiple' : 'single'"
        binary-state-sort
        bordered
        row-key="id"
        @request="onRequest"
      >
        <template v-slot:top>
          <q-toolbar class="text-primary">
            ...
            <div
              ...
              <q-btn
                v-if="can('admin.management.roles.updateRole')"
                :dense="$q.screen.lt.md"
              ...
              <q-btn
                v-if="can('admin.management.roles.createRole')"
                :dense="$q.screen.lt.md"
        ...
        <template v-slot:body-cell-action="props">
          <q-td :props="props">
            <q-btn
              :disable="!can('admin.management.roles.viewRole')"
