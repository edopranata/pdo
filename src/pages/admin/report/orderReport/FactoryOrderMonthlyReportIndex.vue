...
const {path} = useRoute()
const {selected_factory, factories_option, errors, form_monthly} = storeToRefs(useDeliveryOrderDataStore())
        ...
        <q-markup-table bordered flat>
          ...
          <tr class="text-bold bg-primary text-white">
            ...
            <td class="text-right">{{
                ...
                }).format(table.summaries.customer_price)
              }}
            </td>
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
                  style: 'unit',
                  unit: "kilogram"
                }).format(table.summaries.total_weight)
              }}
            </td>
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
                ...
                }).format(table.summaries.customer_total)
              }}
            </td>
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
            ...
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
                  ...
                  currency: "IDR",
                  maximumFractionDigits: 0
                }).format(table.summaries.factory_price)
              }}
            </td>
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
                  ...
                  currency: "IDR",
                  maximumFractionDigits: 2
                }).format(table.summaries.gross_total)
              }}
            </td>
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
                  ...
                  currency: "IDR",
                  maximumFractionDigits: 2
                }).format(table.summaries.ppn_total)
              }}
            </td>
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
                  ...
                  currency: "IDR",
                  maximumFractionDigits: 2
                }).format(table.summaries.pph22_total)
              }}
            </td>
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
            ...
            <td class="text-right">{{
                new Intl.NumberFormat('id-ID', {
                  ...
                  currency: "IDR",
                  maximumFractionDigits: 2
                }).format(parseFloat(table.summaries.gross_total) - (table.summaries.customer_total + table.summaries.pph22_total))
              }}
            </td>
          </tr>
